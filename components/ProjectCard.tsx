...
export default function ProjectCard({ title, href, imageSrc, subtitle }: ProjectCardProps) {
  ...
  return (
    ...
    >
      <div className="project-card bg-white/5 backdrop-blur-sm rounded-2xl h-full flex flex-col border shadow-[0_0_12px_rgba(0,0,0,0.25)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(52,8,147,0.15)]">
