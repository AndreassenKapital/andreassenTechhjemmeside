...
export default function SimpleProfileCard({ 
  ...
  const grad =
    accent === "teal"
      ? "from-teal-400/25 to-teal-300/10"
      : accent === "violet"
      ? "from-violet-400/25 to-fuchsia-300/10"
  ...
  return (
    <div className="relative mx-auto max-w-md rounded-3xl p-[2px]">
      {/* Subtil border/halo */}
      <div 
        className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${grad} blur-[8px]`}
        style={{ opacity: intensity }}
      ></div>

      {/* Card body */}
      <div className="relative rounded-3xl bg-neutral-900/80 ring-1 ring-white/10 overflow-hidden backdrop-blur-sm">
        ...
        <div className="px-5 py-6">
          <h2 className={`text-2xl md:text-3xl font-semibold tracking-tight ${nameClassName}`}>{name}</h2>
